...
echo '   - load mars_mcu_fw.bin to {address_hex(consts["FW8051_DDR_ADDR"])}'
echo '   - jump to bootloader.bin; kernel.bin will map and release the 8051 watchdog'
...
def main():
    ...
    manifest = {
        ...
        "usb_serial": {
            ...
            "dwc2_base": "0x04340000",
            "syscon_base": "0x03006000",
            "irq": 30,
            "plic_context": "supervisor context 1",
            "udc_name": "40e0000.cvi-usb-dev",
            "otg_base": "0x040c0000",
            "dev_base": "0x040e0000",
            "note": "the native bare-metal DWC2 backend is still a scaffold until EP0 handling and endpoint scheduling are completed; it now models the Nano W vendor DTB MMIO/IRQ facts and uses a minimal PLIC claim/complete polling path when enabled with -DKRAKEN_ENABLE_USB_DWC2_SCAFFOLD=1",
        },
